...
import com.qcp.common_design.R
import kotlinx.android.synthetic.main.elegant_dilaog.*
        ...
        fun build(
            ...
            val alertDialog =
                AlertDialog.Builder(
                    ...
                    .setView(R.layout.elegant_dilaog)
...
fun AlertDialog.position(
    position: ElegantDialog.POSITIONS = ElegantDialog.POSITIONS.BOTTOM
): AlertDialog {
    val layoutParams = mainLayout.layoutParams as RelativeLayout.LayoutParams
    if (position == ElegantDialog.POSITIONS.CENTER) {
        layoutParams.addRule(RelativeLayout.CENTER_VERTICAL, RelativeLayout.TRUE)
    } else if (position == ElegantDialog.POSITIONS.BOTTOM) {
